...
<div class="card" style="width:100%">
        ...
        <div class="card-body">
          ...
          <p class="card-text">${data.capital??"no capital"}</p>
        </div>
        <ul class="list-group list-group-flush">
          <li class="list-group-item">${data.population}</li>
          <li class="list-group-item">${data.region}</li>
          <li class="list-group-item">${data.borders}</li>
        </ul>
